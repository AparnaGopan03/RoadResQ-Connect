<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TowingSignUp.aspx.vb" Inherits="roadresqconnect.TowingSignUp" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Towing Sign Up</title>
 <style>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblAddress" runat="server" Text="Service Center:"></asp:Label>
