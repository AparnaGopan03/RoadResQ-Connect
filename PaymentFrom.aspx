<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PaymentFrom.aspx.vb" Inherits="roadresqconnect.PaymentFrom" %>
                    ...
                    <div id="page-content-wrapper">
                        <div class="row pt-3" id="border-btm">
                            ...
                            <div class="col-8">
                                ...
                                <div class="row justify-content-right">
                                    <div class="col-12">
                                        <p class="mb-0 mr-4 text-right"> <span class="top-highlight"></span> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                       <%-- <div class="row justify-content-center">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-11">
                                        <div class="form-card">
                                            ...
                                            <form onsubmit="event.preventDefault()">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12"> <asp:Button ID="Button1" runat="server" Text="Pay" CssClass="btn btn-success placeicon"  /> </div>
                                                </div>
                                               <%-- <div class="row">
                                                    <div class="col-md-12">
                                    ...
                                    <div class="col-11">
                                        <div class="form-card">
                                            ...
                                            <form onsubmit="event.preventDefault()">
                                                ...
                                                <br />
                                                <div class="row">
                                                    <div class="col-md-12"> <center> <a href="PaymentSuccess.aspx" id="btnPay" class="btn btn-success placeicon">Pay</a></center>


                                                </div>
                                               <%-- <div class="row">
                                                    <div class="col-md-12">
                                                        <p class="text-center mb-5" id="P1"><a href="#">Use a test card</a></p>
                                                    </div>
                                                </div>--%>
                                            </form>
                                        </div>
                            ...
                            <div id="menu3" class="tab-pane">
                                <div class="row justify-content-center">
                                    <div class="col-11">
                                        <h3 class="mt-0 mb-4 text-center"><br />
                                            <br /> OR Scan the QR code to pay</h3>
                                        <div class="row justify-content-center">
