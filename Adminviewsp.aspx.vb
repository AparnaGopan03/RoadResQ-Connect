...
Public Class Adminviewsp
    ...
    Protected Sub btnFilter_Click(sender As Object, e As EventArgs) Handles btnFilter.Click
        Dim providerid As String = txtCustomerID.Text.Trim()
        ...
        If Not String.IsNullOrEmpty(providerid) Then
            ...
            Dim query As String = "SELECT providerid, username, email, name, dob, gender, address, contactnumber FROM Serviceprovider WHERE providerid = @custID"
    ...
    Private Sub BindGridView()
        ...
        Dim connectionString As String = "Data Source=LAPTOP-SFCGJITP;Initial Catalog=Roadside Assistance;User ID=sa;Password=123"
        Dim query As String = "SELECT providerid, username, email, name, dob, gender, address, contactnumber FROM Serviceprovider"
    ...
    Protected Sub GridView1_RowDeleting(sender As Object, e As GridViewDeleteEventArgs)
        ...
        Dim connectionString As String = "Data Source=LAPTOP-SFCGJITP;Initial Catalog=Roadside Assistance;User ID=sa;Password=123"
        Dim query As String = "DELETE FROM Serviceprovider WHERE providerid = @custID"
    ...
    Protected Function GetServiceRequests(customerId As Object) As String
        ...
        Dim query As String = "SELECT COUNT(*) FROM Cservicerequest WHERE providerid = @customerId"
